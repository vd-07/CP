...
for(int i = 1; i <= 9; i++) {
  switch(i) {
    case 1: p = 1, q = 1; break;
    case 2: p = 2, q = 4; break;
    case 3: p = 3, q = 7; break;
    case 4: p = 4, q = 2; break;
    case 5: p = 5, q = 5; break;
    case 6: p = 6, q = 8; break;
    case 7: p = 7, q = 3; break;
    case 8: p = 8, q = 6; break;
    case 9: p = 9, q = 9; break;
  }
  if(sudoku[p][q] == '2')
    sudoku[p][q] = '3';
  else
